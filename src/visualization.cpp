...
void filterCallback(const std_msgs::Float32::ConstPtr &msg){
    tf2::Quaternion q;
    geometry_msgs::Quaternion qm;

    q.setRPY(0, angles::from_degrees(-msg->data), 0);
    qm= tf2::toMsg(q);
...
int main( int argc, char** argv )
{
  ...
  ros::Subscriber sub= n.subscribe("/teleop/angle", 1000, filterCallback);
